...
function CreateSurfaceData() {
  ...
  for (let v = 0; v < 360; v += 20) {
    for (let i = -10; i < maxI; i += stepI) {
      for (let j = -10; j < maxJ; j += stepJ) {
        let first =
          ((a +
            c * Math.pow(Math.cos(j), 3) * Math.cos(v) +
            c * Math.pow(Math.sin(j), 3) * Math.sin(v)) *
            Math.cos(i)) /
          2;
        let second =
          ((a +
        ...
        let third =
          (b * i -
            c * Math.pow(Math.cos(j), 3) * Math.sin(v) +
            c * Math.pow(Math.sin(j), 3) * Math.cos(v)) /
          2;
        vertexList.push(first, second, third);
        textureList.push(getI(i), getJ(j));

        first =
          ((a +
            c * Math.pow(Math.cos(j + stepJ), 3) * Math.cos(v) +
            c * Math.pow(Math.sin(j + stepJ), 3) * Math.sin(v)) *
            Math.cos(i + stepI)) /
          2;
        second =
          ((a +
        ...
        third =
          (b * (i + stepI) -
            c * Math.pow(Math.cos(j + stepJ), 3) * Math.sin(v) +
            c * Math.pow(Math.sin(j + stepJ), 3) * Math.cos(v)) /
          2;
